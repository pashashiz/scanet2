...
trait ConvertableToFloat extends ConvertableTo[Float] {
  ...
  override def fromShort(n: Short): Float = n.toFloat
...
trait ConvertableToDouble extends ConvertableTo[Double] {
  ...
  override def fromShort(n: Short): Double = n.toDouble
...
trait ConvertableToLong extends ConvertableTo[Long] {
  ...
  override def fromShort(n: Short): Long = n.toLong
...
trait ConvertableToInt extends ConvertableTo[Int] {
  ...
  override def fromShort(n: Short): Int = n.toInt
...
trait ConvertableToShort extends ConvertableTo[Short] {
  override def fromByte(n: Byte): Short = n.toShort
  override def fromShort(n: Short): Short = n
  override def fromInt(n: Int): Short = n.toShort
  override def fromLong(n: Long): Short = n.toShort
  override def fromFloat(n: Float): Short = n.toShort
  override def fromDouble(n: Double): Short = n.toShort
  override def fromType[B: ConvertableFrom](b: B): Short = ConvertableFrom[B].toShort(b)
}

trait ConvertableToByte extends ConvertableTo[Byte] {
  override def fromByte(n: Byte): Byte = n
  override def fromShort(n: Short): Byte = n.toByte
...
trait ConvertableFromFloat extends ConvertableFrom[Float] {
  ...
  override def toShort(a: Float): Short = a.toShort
...
trait ConvertableFromDouble extends ConvertableFrom[Double] {
  ...
  override def toShort(a: Double): Short = a.toShort
...
trait ConvertableFromLong extends ConvertableFrom[Long] {
  ...
  override def toShort(a: Long): Short = a.toShort
...
trait ConvertableFromInt extends ConvertableFrom[Int] {
  ...
  override def toShort(a: Int): Short = a.toShort
...
trait ConvertableFromShort extends ConvertableFrom[Short] {
  override def toByte(a: Short): Byte = a.toByte
  override def toShort(a: Short): Short = a
  override def toInt(a: Short): Int = a.toInt
  override def toLong(a: Short): Long = a.toLong
  override def toFloat(a: Short): Float = a.toFloat
  override def toDouble(a: Short): Double = a.toDouble
  override def toType[B: ConvertableTo](a: Short): B = ConvertableTo[B].fromShort(a)
  override def asString(a: Short): String = a.toString
}

trait ConvertableFromByte extends ConvertableFrom[Byte] {
  override def toByte(a: Byte): Byte = a
  override def toShort(a: Byte): Short = a.toShort
